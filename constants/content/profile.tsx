...
export const profile = {
  ...
  statement: (
    <>
      ...
      products that deliver real value by leveraging a wide range of technologies and skills,
      including (but not limited to){" "}
      <b>Javascript/Typescript, React, Next.js, Solidity, SQL/No-SQL, AWS, and more.</b>
    </>
  ),
